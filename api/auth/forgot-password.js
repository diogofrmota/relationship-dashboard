          ...
          await resend.emails.send({
            ...
            html: `
              <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px">
                ...
                <a href="${resetUrl}" style="display:inline-block;margin:24px 0;padding:12px 24px;background:#c1121f;color:#fdf0d5;border-radius:8px;text-decoration:none;font-weight:600">
                  Reset password
                </a>
